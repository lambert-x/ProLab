...
model = dict(
    ...
    decode_head=dict(
        ...
        ignore_index=None,
        desc_model_name=
        'bge-base-en-v1.5_gpt3.5_cluster_128_embeddings_and_labels',
        desc_weights_dict_path=
        'embeddings/pascal_context_59_desc_bge-base-en-v1.5_gpt3.5_cluster_128_embedding_bank.pth',
    ...
    desc_model_name='bge-base-en-v1.5_gpt3.5_cluster_128_embeddings_and_labels',
    desc_weights_dict_path=
    'embeddings/pascal_context_59_desc_bge-base-en-v1.5_gpt3.5_cluster_128_embedding_bank.pth',
    get_logit_mode='cosine_similarity_with_sigmoid',
    sigmoid_temperature=0.04,
...
pretrained = 'pretrained/deit_base_patch16_224-b5f2ef4d.pth'
work_dir = './work_dirs/pascal_context/upernet_deit_adapter_base_512_160k_pascal_context_59_bge_base_gpt3.5_cluster_128_cosine_simi_with_sigmoid_cosine_loss_temp_0.04_unnormalized/'
gpu_ids = range(0, 8)
auto_resume = False
