...
pretrained = 'pretrained/deit_base_patch16_224-b5f2ef4d.pth'
work_dir = './work_dirs/cityscapes/upernet_deit_adapter_base_768_160k_cityscapes_bge_base_gpt3.5_cluster_32_cosine_simi_with_sigmoid_cosine_loss_temp_0.04_unnormalized'
gpu_ids = range(0, 8)
auto_resume = False
