...
model = dict(
    ...
    decode_head=dict(
        ...
        desc_model_name='descriptors_coco_stuff_164k_gpt3.5_cluster_on_coco_stuff_164k',
        desc_weights_dict_path='openvoc_cluster_desc/openvoc_embeddings_and_labels_gpt3.5_cluster_on_coco_stuff_164k.pth',
