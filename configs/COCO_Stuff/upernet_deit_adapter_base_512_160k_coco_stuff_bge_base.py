...
model = dict(
    ...
    decode_head=dict(
        ...
        desc_model_name='bge-base-en-v1.5_gpt3.5_cluster_256_embeddings_and_labels',
        desc_weights_dict_path='embeddings/coco_stuff_164k_desc_bge-base-en-v1.5_gpt3.5_cluster_256_embedding_bank.pth',
