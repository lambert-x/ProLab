...
class FCNHead_CLIP_T5(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 clip_weights_dict_path = 'embeddings/ade_zeroshot_weights_dict.pth',
        ...
        super(FCNHead_CLIP_T5, self).__init__(**kwargs)
        if num_convs == 0:
        ...
        clip_feature_len = clip_embedding_bank.shape[1]
        self.clip_embedding_bank = torch.cat([clip_embedding_bank, torch.zeros(1, clip_feature_len).to(clip_embedding_bank.device)]).cuda()
